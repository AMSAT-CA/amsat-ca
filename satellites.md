...
sections:
  - type: text-section
    heading: Amateur Radio Satellites
    text: >-
      ...
      * Astronomical satellites: are very large telescopes in space used for viewing the far reaches of our universe (for e.g. the James Web telescope).
      ...
      ![James Webb Space Telescope](/assets/media/jwst.png)
      ...
      **Frequencies and location:**
      ...
      Stay tuned for future articles about Antenna Polarization, a more in-depth look into an amateur satellite, components of a satellite station and communicating using those satellites.[](https://www.calgarytospace.ca/)
---
